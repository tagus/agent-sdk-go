...
require (
	...
	github.com/weaviate/weaviate-go-client/v5 v5.0.1
...
replace (
	...
	go.opentelemetry.io/otel/exporters/otlp/otlptrace/otlptracehttp => go.opentelemetry.io/otel/exporters/otlp/otlptrace/otlptracehttp v1.23.0
